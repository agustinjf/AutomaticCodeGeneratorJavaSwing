...
/**
 * Panel de cargando que deberá mostrarse en cada operación que requiera
 * comunicación con el servidor
 *
 * @author ajifernandez
 *
 */
public class GlassPanel extends JComponent implements MouseListener {
	/** Serial Version */
	 ...
	 * @param rampDelay
	 */
	public GlassPanel(String text, int barsCount, float shield, float fps, int rampDelay) {
		this.text = text;
	...
	protected class Animator implements Runnable {
		...
		public void run() {
			...
			if (!rampUp) {
				...
				setVisible(false);
				removeMouseListener(GlassPanel.this);
			}
		}
	}
